...
#define MQTT_SUB_SENSOR "sensor/sensor1"
...
void onMqttConnect(bool sessionPresent) {
  ...
  uint16_t packetIdSub = mqttClient.subscribe(MQTT_SUB_SENSOR, 0);
  Serial.printf("Subscribing on topic %s at QoS 1, packetId: %i", MQTT_SUB_SENSOR, packetIdSub);
}
...
void onMqttMessage(char* topic, char* payload, AsyncMqttClientMessageProperties properties, size_t len, size_t index, size_t total) {
  ...
  if((String(topic) == MQTT_SUB_SENSOR) &&(String(new_payload) =="Open")){
